...
def draw_prediction_info(game, ui):
	...
	ui.separator()
	ui.text("Using Standard Prediction " + Version, ColorPurple)
	if is_champ_supported(game.player):
		ui.text(game.player.name.upper() + " has skillshot prediction support", ColorGreen)
	else:
		ui.text(game.player.name.upper() + " doesn't have skillshot prediction support", ColorRed)
